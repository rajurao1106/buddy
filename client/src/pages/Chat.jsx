...
const socket = io("https://buddy-5ext.onrender.com"); // Replace with your socket server URL
...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    // Listen for new tasks from WebSocket server
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Emit the new task to the WebSocket server
